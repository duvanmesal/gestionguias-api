...
Como sistema, al registrar un NO_SHOW, quiero penalizar al guia ausente y reasignar el turno al siguiente en cola, para mantener la cobertura operativa y disuadir inasistencias.
