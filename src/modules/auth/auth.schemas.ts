...
export const updateUserSchema = z.object({
  nombres: z.string().min(1, "First name is required").max(100, "First name too long").optional(),
  apellidos: z.string().min(1, "Last name is required").max(100, "Last name too long").optional(),
