...
export class AuthController {
  async login(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result = await authService.login(req, data, platform, ip, userAgent)
  ...
  async refresh(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result = await authService.refresh(req, refreshToken, platform, ip, userAgent)
  ...
  async verifyEmailConfirm(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result = await authService.verifyEmailConfirm(req, body.token)
