...
export class TurnoService {
  ...
  static getByIdForActor(req: Request, turnoId: number, actorUserId: string, actorRol: RolType) {
  ...
  static assign(req: Request, turnoId: number, guiaId: string, actorUserId: string) {
    return assignTurnoUsecase(req, turnoId, guiaId, actorUserId)
  }

  static unassign(req: Request, turnoId: number, reason: string | undefined, actorUserId: string) {
    return unassignTurnoUsecase(req, turnoId, reason, actorUserId)
  }

  static cancel(req: Request, turnoId: number, cancelReason: string | undefined, actorUserId: string) {
  ...
  static noShow(req: Request, turnoId: number, reason: string | undefined, actorUserId: string) {
