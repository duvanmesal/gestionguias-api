...
export class UserController {
  ...
  async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      // ✅ pass req
      const user = await userService.update(req, id, data, updatedBy, updaterRole)
  ...
  async updateMe(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      logger.info({ userId, changes: Object.keys(data) }, "Profile updated successfully (me)")
      res.json(ok(user))
    } catch (error) {
      next(error)
    }
  ...
  async completeProfile(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      logger.info({ userId, profileStatus: user.profileStatus }, "Profile completed successfully")
